...
import { updateProduct } from '@/app/services/requestService';
import { PhotoIcon } from '@heroicons/react/24/solid';
import { useEffect, useState } from 'react';
  
interface EditProductProps {
  initialProductDetails: Product | null;
}

export default function EditProduct({
  initialProductDetails,
}: EditProductProps) {
  const [productDetails, setProductDetails] = useState<Product | null>(initialProductDetails);
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <img src={productDetails.image_path} alt={productDetails.description} className="w-36 h-36 rounded-lg object-cover" />
